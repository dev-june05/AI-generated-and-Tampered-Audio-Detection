...
def train(
    ...
    # -----------------------------------------------------------------------
    # 1. Split train dir based on val_split
    # -----------------------------------------------------------------------
    ...
    val_indices = all_train_indices[TRAIN_SIZE:]

    train_dataset = Subset(full_train_dataset, train_indices)
    val_dataset = Subset(full_train_dataset, val_indices)

    # -----------------------------------------------------------------------
    # 2. Load test dir (separate, NOT used during training)
    # -----------------------------------------------------------------------
    test_dataset = None
    test_count = 0
    if test_dir is not None:
        try:
            test_dataset = AudioDataset(test_dir, mode=architecture)
    ...
    logger.info("Total train samples: %d", total_train_samples)
